    ...
    return (
      <div className='flex-grow flex-col'>
        <div className="bg-gray-50 flex flex-grow flex-col pr-6 pl-6 md:pr-40 md:pl-40 md:pt-8 md:pb-8 pt-4 pb-4">
           <h1 className="pt-4 pb-4 text-lg sm:text-1xl md:text-2xl lg:text-4xl font-bold mt-2  text-[#8b0000]" >Executive Board</h1>
        ...
        <div className="bg-white flex flex-grow flex-col pr-6 pl-6 md:pr-40 md:pl-40 md:pt-8 md:pb-8 pt-4 pb-4">
           <h1 className="pt-4 pb-4 text-lg sm:text-1xl md:text-2xl lg:text-4xl font-bold mt-2  text-[#8b0000] text-right" >Brothers</h1>
        ...
        <div className="bg-gray-50 flex flex-grow flex-col pr-6 pl-6 md:pr-40 md:pl-40 md:pt-8 md:pb-8 pt-4 pb-4">
           <h1 className="pt-4 pb-4 text-lg sm:text-1xl md:text-2xl lg:text-4xl font-bold mt-2  text-[#8b0000]" >Contact Us</h1>
