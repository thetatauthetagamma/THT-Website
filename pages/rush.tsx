      ...
      <div className="bg-gray-50 flex-grow">
        <script
          ...
          <div className="inset-0 flex flex-col justify-center items-center pt-4 text-[#8b0000]">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold z-3 mt-2 mb-1" >Rush</h1>
            <h1 className="text-2xl sm:text-2xl md:text-4xl lg:text-6xl font-bold z-3" >THETA TAU</h1>
          </div>
        
          <div className=" flex-row text-lg sm:text-base md:text-lg lg:text-xl px-4 pr-6 pl-6 md:pr-40 md:pl-40 text-center py-4 font-semibold z-3 mt-2">
            <p>
              Please fill out our&nbsp;
          ...
          <div>
            <div className="inset-0 flex flex-col justify-center items-center pt-4 text-[#8b0000]">
              <h1 className="text-2xl md:text-3xl font-bold z-3 mt-2 mb-1" >Frequently Asked Questions</h1>
